...
import { ArtistJumbotron, ReleaseSection, ArtistSection, StuffPicksSection, BlogSection } from 'components';
...
export default class Artist extends Component
{
  ...
  componentWillReceiveProps(nextProps) {
    if (parseInt(this.context.store.getState().artist.data.id, 10) !== parseInt(nextProps.params.id, 10)) {
